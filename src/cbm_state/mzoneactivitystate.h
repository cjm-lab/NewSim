...
enum {
  CASCADE_STATE_MIN_DEEPEST,
  CASCADE_STATE_MIN_DEEPER,
  CASCADE_STATE_MIN_SHALLOW,
  CASCADE_STATE_MIN_SHALLOWEST,
  CASCADE_STATE_MAX_SHALLOWEST,
  CASCADE_STATE_MAX_SHALLOWER,
  CASCADE_STATE_MAX_DEEPER,
  CASCADE_STATE_MAX_DEEPEST
};
...
public:
  ...
  std::unique_ptr<uint8_t[]> apBufIO{
      nullptr}; /* should this be a byte array? */
